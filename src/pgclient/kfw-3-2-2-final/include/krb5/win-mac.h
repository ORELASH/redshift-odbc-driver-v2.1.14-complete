...
#define HAVE_NETINET_IN_H 1 /* IHG */
#define MSDOS_FILESYSTEM
#define HAVE_STRING_H 1 /* IHG */
#define HAVE_SRAND
#define HAVE_ERRNO
#define HAVE_STRDUP 1 /* IHG */
#define HAVE_GETADDRINFO
#define HAVE_GETNAMEINFO
#define NO_USERID
#define NO_PASSWORD
#define HAVE_STRERROR 1 /* IHG */
...
#define HAVE_SYS_TYPES_H 1 /* IHG */
#define HAVE_STDLIB_H 1 /* IHG */
